...
{* Offcanvas buttons *}
{block name='frontend_detail_lieferumfang_buttons_offcanvas'}
    <div class="buttons--off-canvas">
        {block name='frontend_detail_lieferumfang_buttons_offcanvas_inner'}
...
<div class="content--description">
	...
	{* Headline *}
	{* {block name='frontend_detail_lieferumfang_title'}*}
	...
	{* Product description *}
	{block name='frontend_detail_lieferumfang_text'}
	...
	{block name='frontend_detail_lieferumfang_links'}

		

		{* Links list *}
		{block name='frontend_detail_lieferumfang_links_list'}
			<ul class="content--list list--unstyled">
				...
				{foreach $sArticle.sLinks as $information}
					{if $information.supplierSearch}
						...
						{block name='frontend_detail_lieferumfang_links_supplier'}
							<li class="list--entry">
					...
					{else}
						...
						{block name='frontend_detail_lieferumfang_links_link'}
