<div class="navigation--list-wrapper">
    <ul class="navigation--list container" role="menubar" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
     ...
     {* Trennzeichen zwischen vorletztem und letztem Menüeintrag einfügen, der über class="is--trenner gestylt werden kann" *}   
        
                    {if $sCategory@last}<span class="is--trenner"></span>{/if}
